...
public class DemoStrings {
    public static String[] stringsArray = {"camelCase, apple, BICYCLE, BlackBoard, sixApples, iReallyLikeToLearnSomethingNew",
            "Mike takes the black ball. Blackout curtains hang on the window. findCamelCase, diGItalTEchnology, letterA",
            "Andrew has 3 apples, and Lindsey has 265 apples. We have next values: 12, 1, 343, 9, 0, 11",
